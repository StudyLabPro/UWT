...
Referenced from `design-taste-frontend/SKILL.md` Section 14 (Final Pre-Flight Check) and Section 4.10 (Quotes & Testimonials). Avoid these signatures unless the brief explicitly asks for them.
